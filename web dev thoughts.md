the techniques you are learning to create web apps, it is just a memorisation of steps to create a crud (create/store, read, update, delete, protect with authorization) operations on information.
